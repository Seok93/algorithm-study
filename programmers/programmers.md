...
- [x] Level2 [프로세스](./level2/프로세스/problem.md)
- [x] Level2 [다리를 지나는 트럭](./stack_queue/다리를지나는트럭/problem.md)
- [x] Level2 [주식가격](./level2/주식가격//problem.md)
...
|[연속된 부분 수열의 합](./level2/연속된%20부분%20수열의%20합/problem.md)|△|투포인터|
|[124 나라의 숫자](./level2/124%20나라의%20숫자/problem.md)|X||
...
|[무인도 여행](./level2/무인도%20여행//problem.md)|△|완전탐색(DFS/BFS)|
...
|[2020 카카오 인턴십 > 보석 쇼핑](./level3/보석%20쇼핑/problem.md)|O|투포인터 알고리즘 & Map의 삽입 순서를 유지해주는 특성 활용|